...
export class InsertInState1707399434585 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
            ...
            INSERT INTO state("id", "name", "uf") VALUES (16, 'Pernambunco', 'PE');
            ...
            INSERT INTO state("id", "name", "uf") VALUES (24, 'Sanata Catarina', 'SC');
